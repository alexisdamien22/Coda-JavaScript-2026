export class TaskListView {
    ...
    render(tasks) {
        ...
        //? méthode 1
        //!tasks.forEach((task) => {
        //!    const taskItem = this.#createTaskElement();
        ...
        this.#containerElement.append(...taskItems);
    }
    ...
    #createTaskElement(task) {
        ...
        //* OU taskToggleElement.setAttribute("type = checkbox");
        ...
        taskActionsElement.cllassList.add("task-actions");
